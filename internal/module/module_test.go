...
var checkTests = []struct {
	...
	// we accept the old pseudo-versions to avoid breaking existing z.mod files.
	// For example gopkg.in/yaml.v2@v2.2.1's z.mod requires check.v1 at a v0 pseudo-version.
