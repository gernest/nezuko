...
import (
	...
	"github.com/gernest/nezuko/internal/dirhash"
...
modules have been changed and causes 'z mod' to exit with a
non-zero status.
	`,
	Run: runVerify,
}
...
func runVerify(cmd *base.Command, args []string) {
	if len(args) != 0 {
		...
		base.Fatalf("z mod verify: verify takes no arguments")
	}
	ok := true
